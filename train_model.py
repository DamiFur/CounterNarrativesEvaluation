...
writer.write("{},{},{},{}\n".format(results.metrics["accuracy"], results.metrics["f1"], results.metrics["precision"], results.metrics["recall"]))
writer.write("{}\n".format(results.metrics["f1_per_category"]))
writer.write("{}\n".format(results.metrics["confusion_matrix"]))
writer.close()
